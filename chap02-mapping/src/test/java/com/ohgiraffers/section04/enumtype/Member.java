...
public class Member {
    ...
    //@Enumerated(EnumType.ORDINAL) // enum type의 인덱스 기준으로 값이 들어감
    ...
    public Member(int memberNo, String memberId, String memberPwd, String nickname, String address, Date enrollDate, String phone, String email, RoleType memberRole, String status) {
