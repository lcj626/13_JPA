...
public class PrimaryKeyMappingTests {
    ...
    * */
    ...
    public void 식별자_매핑_테스트() {
        ...
        //then
        String jpql = "SELECT A.memberNo FROM member_section03_subsection01 A"; // 사용자가 정의한 sql 구문 - jpql
        List<Integer> memberNoList = entityManager.createQuery(jpql, Integer.class).getResultList(); // List memberNo 출력(위에 새로 등록한 user01, user02)
